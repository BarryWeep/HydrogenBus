...
router.get('/', (req, res) => {
    ...
    db.query(query, (err, DateTimeRequired) => {
      ...
      db.query(query, (err, results) => {
        ...
        res.render('index', { neededData: neededData, chartDistanceDriven:chartDistanceDriven,chartRegenerationRate:chartRegenerationRate,chartDate:chartDate,chartAveragespeed:chartAveragespeed,chartSocUsed:chartSocUsed,chartEnegeryUsed:chartEnegeryUsed});
      });
